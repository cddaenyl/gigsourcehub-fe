...
import type { FAQ, FAQStatus } from '@/models/FAQ'
...
const emit = defineEmits<{
  action: [action: 'edit' | 'delete', faq: FAQ]
}>()
...
function getStatusStyle(status: FAQStatus | null): { color: string; textColor: string } {
  switch (status) {
    case 'PUBLISHED':
...
function getStatusLabel(status: FAQStatus | null): string {
  switch (status) {
