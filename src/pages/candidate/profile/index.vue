...
import { 
  NUpload, NButton, NForm, NFormItem, NInput, 
        ...
        <div v-if="currentStep === 'VIEW'">
          <div class="relative">
            ...
            <div class="relative mt-0">
                ...
                <div v-if="isProfileLocked" class="absolute inset-0 z-10 flex flex-col items-center justify-center bg-white/40 backdrop-blur-md rounded-3xl p-12 text-center">
